...
«راز بازار بزرگ» یک بازی معمایی و داستان‌محور فارسی برای موبایل است که بازیکن را در نقش کارآگاه وارد یک پرونده در بازار قدیمی تهران می‌کند.
- جست‌وجوی صحنه‌ها و پیدا کردن سرنخ‌های تعاملی با نقطه‌های لمس
- دفتر کارآگاه برای مرور مدرک‌ها، رمزها و نکته‌های پرونده
- گفت‌وگو با شخصیت‌ها و مقایسهٔ گفته‌ها با شواهد
- معماهای منطقی مانند پیدا کردن مسیر، رمز کمد و تطبیق بسته‌بندی
- امتیازدهی بر پایهٔ تصمیم‌ها؛ پاسخ اشتباه از سکه‌ها کم می‌کند
- محاسبه و ذخیرهٔ سکه، ستاره و تعداد پرونده‌های تکمیل‌شده
- موسیقی پس‌زمینه و افکت کلیک، با امکان قطع و وصل موسیقی
- تجربهٔ آفلاین، تک‌نفره، افقی و کاملاً فارسی برای کودکان و نوجوانان